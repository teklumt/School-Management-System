...
private void disableTextFields() {
    ...
    private void updateUIWithStudentDetails(Student student) {
        name.setText(student.getName());
        fname.setText(student.getFatherName());
        mname.setText(student.getMotherName());
        ddob.setSelectedIndex(student.getDobDay() - 1);
        mdob.setSelectedIndex(student.getDobMonth());
        ydob.setSelectedIndex(student.getDobYear() - 95);
        Cno.setText(student.getContactNumber());
        Add.setText(student.getAddress());
        ddoa.setSelectedIndex(student.getDoaDay() - 1);
        mdoa.setSelectedIndex(student.getDoaMonth());
        ydoa.setSelectedIndex(student.getDoaYear() - 103);
        cAdm.setSelectedItem(student.getClassOfAdmission());
        pc.setSelectedItem(student.getPresentClass());
        enableTextFields();
    }

   private void updateStudentDetailsFromUI(Student student) {
    student.setName(name.getText());
    student.setFatherName(fname.getText());
    student.setMotherName(mname.getText());
    student.setAddress(Add.getText());

 
    int dd = ddob.getSelectedIndex() + 1;
    int mm = mdob.getSelectedIndex() + 1; 
    int yy = Integer.parseInt((String) ydob.getSelectedItem()) + 95; 
    student.setDobDay(dd);
    student.setDobMonth(mm);
    student.setDobYear(yy);


    int dda = ddoa.getSelectedIndex() + 1;
    int mma = mdoa.getSelectedIndex() + 1; // Adjust if necessary
    int yya = Integer.parseInt((String) ydoa.getSelectedItem()) + 103; // Adjust if necessary
    student.setDoaDay(dda);
    student.setDoaMonth(mma);
    student.setDoaYear(yya);


    student.setContactNumber(Cno.getText()); // Assuming Cno is a JTextField
    student.setClassOfAdmission((String) cAdm.getSelectedItem());

    
    student.setPresentClass((String) pc.getSelectedItem());
}
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(185, 72, 108, 30);
        ...
        cAdm.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Software", "Civil", "Mechanical", "Enviromental" }));
        ...
        pc.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Software", "Civil", "Mechanical", "Enviromental" }));
        jPanel1.add(pc);
        ...
        jButton2.setBounds(130, 510, 72, 30);
        ...
        jButton3.setBounds(500, 510, 72, 30);
        ...
        jButton4.setBounds(220, 450, 84, 30);
        ...
        jButton5.setBounds(380, 450, 76, 30);
        ...
        jButton6.setBounds(300, 510, 72, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Date d = new Date();
            try {
                Student student = studentDatabase.getStudentById(sno);

                schno.setEnabled(false);

                if (student != null) {
                    updateUIWithStudentDetails(student);
                } else {
                ...
                JOptionPane.showMessageDialog(this, "Please enter a valid Scholar Number", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
            // Handle exceptions
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (sno.isEmpty()) {
            ...
            Student student = studentDatabase.getStudentById(Integer.parseInt(sno));
            if (student != null) {
                updateStudentDetailsFromUI(student);
        ...
        if (sno.isEmpty()) {
            ...
            try {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    studentDatabase.removeStudent(Integer.parseInt(sno));
                    JOptionPane.showMessageDialog(this, "Successfully Deleted");
                    resetUI();
                }
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "Invalid Scholar Number", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
