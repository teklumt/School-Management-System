...
public class NewTeacher extends javax.swing.JFrame {
    ...
    if (tid.isEmpty()) {
        ...
        dd = Integer.parseInt(jComboBox3.getSelectedItem().toString().trim());
        ...
        yy = Integer.parseInt(jComboBox5.getSelectedItem().toString().trim());
        dob = yy + "/" + mm + "/" + dd;
        cno = Cno.getText().trim();
        add = Add.getText().trim();
        post = (String) jComboBox6.getSelectedItem();
        sal = Sal.getText().trim();

        Teachers newTeacher = new Teachers(tid, nm, dept, dob, cno, add, post, sal);

        if (teacherDatabase.teacherExists(tid)) {
            ...
            if (nm.isEmpty() || cno.isEmpty() || add.isEmpty() || sal.isEmpty()) {
                ...
                teacherDatabase.addTeacher(newTeacher);
