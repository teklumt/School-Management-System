...
public class NewStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox5.setBounds(639, 54, 106, 27);
        ...
        jComboBox7.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Software", "Civil", "Mechanical", "Enviromental" }));
        ...
        jButton1.setBounds(366, 426, 91, 34);
        ...
        jButton4.setBounds(366, 474, 93, 34);
        ...
        jButton5.setBounds(35, 474, 73, 34);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (!StudentDatabase.getInstance().isStudentExists(sno, nm)) {
                if (nm.isEmpty() || fnm.isEmpty() || mnm.isEmpty() || cno.isEmpty() || add.isEmpty()) {
                    ...
                    StudentDatabase.getInstance().addStudent(new Student(sno, nm, fnm, mnm, dd, mm, yy, cno, add, dda, mma, yya, cla, presentClass));
