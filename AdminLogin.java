...
public class AdminLogin extends javax.swing.JFrame {
    ...
    // Create a class to represent Admin data        

    // Use ArrayList to store Admin data
    private AdminDatabase adminDatabase = AdminDatabase.getInstance();

    // Add sample admin data to the list
...
//
//        // Add sample admin data to the AdminDatabase
//        adminDatabase.addAdmin(new Admin("admin1", "password1"));
//        adminDatabase.addAdmin(new Admin("admin2", "password2"));
...
//    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (adpass.equals("1234")) {
            // Check if admin credentials are valid using AdminDatabase
            if (adminDatabase.isAdminCredentialsValid(id1, pass)) {
...
//     private boolean isAdminCredentialsValid(String id, String pass) {
